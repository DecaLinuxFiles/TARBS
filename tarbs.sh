...
# by Tom Tarpey <tomtarpeydev@gmail.com>
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/DecaLinuxFiles/decarice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/DecaLinuxFiles/TARBS/master/progs.csv"
...
selectdotfiles() { \
	edition="$(dialog --title "Select TARBS version." --menu "Select which version of TARBS you wish to have as default:" 10 70 2 i3 "The classic version of TARBS using i3." dwm "The version of TARBS using suckless's dwm." custom "If you are supplying commandline options for TARBS." 3>&1 1>&2 2>&3 3>&1)" || error "User exited."
	}
...
finalize(){ \
	...
	echo "exec_always --no-startup-id notify-send -i ~/.local/share/larbs/larbs.png 'Welcome to TARBS:' 'Press Super+F1 for the manual.' -t 10000"  >> "/home/$name/.config/i3/config"
...
# Let TARBS know the WM it's supposed to run.
